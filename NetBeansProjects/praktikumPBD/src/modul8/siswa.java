...
String[]strJdl = { "Nis", "Nama", "Password", "Alamat", "Email", "JenisKelamin"};
//deklarasi untuk tabel
JTable tabel = new JTable();
JScrollPane skrTabel = new JScrollPane();

siswa(){
    super("Entri Data MHS"); //super harus dipanggil terlebih dahulu dalam konstructor
    setSize(500,300);
    ...
    // menampilkantabel siswa ke komponen table
    TampilTabel();
}
